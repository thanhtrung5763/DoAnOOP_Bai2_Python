...
nv1 = NhanVien("Thanh", "Nam", "DN", "20/09/2020", "12/03/2001", "Phuc Vu")
nv2 = NhanVien("Trung", "Nam", "HCM", "21/10/2020", "14/02/2001", "Thu Ngan")
nv3 = NhanVien("Tram", "Nu", "HN", "02/03/2020", "17/09/1999", "Thu Ngan")
nv4 = NhanVien("Hieu", "Nam", "BB", "14/07/2020", "19/11/1990", "Quan Li")
nv5 = NhanVien("Nhi", "Nu", "BB", "09/01/2020", "21/07/2001", "Pha Che")

f1 = ThucAn("Banh flan vo trung", 30000, "Con", "Sang, Trua, Chieu", "Chay")
...
d3 = ThucUong("Coffe Da", 15000, "Con", "Sang, Toi", "Da")
d4 = ThucUong("Coffe", 15000, "Con", "Sang, Toi", "Khong Da")
